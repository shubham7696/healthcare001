...
function supportNodeRef(node2) {
  if (!(0, import_react9.isValidElement)(node2)) {
    return false;
  }
  if ((0, import_react_is.isFragment)(node2)) {
    return false;
  }
...
var genCSSVarRegister = (component, getDefaultToken, options) => {
  ...
  const useCSSVar = (rootCls) => {
    ...
    return [(node2) => injectStyle && cssVar ? import_react10.default.createElement(import_react10.default.Fragment, null, import_react10.default.createElement(CSSVarRegister, {
      rootCls,
      cssVar,
      component
...
var useNextFrame_default = function() {
  var nextFrameRef = React24.useRef(null);
...
function useStatus(supportMotion, visible, getElement, _ref) {
  ...
  var firstMountChangeRef = React26.useRef(false);
  (0, import_react14.useEffect)(function() {
    if (asyncVisible) {
...
function genCSSMotion(config) {
  ...
  var CSSMotion = React27.forwardRef(function(props, ref) {
    var _props$visible = props.visible, visible = _props$visible === void 0 ? true : _props$visible, _props$removeOnLeave = props.removeOnLeave, removeOnLeave = _props$removeOnLeave === void 0 ? true : _props$removeOnLeave, forceRender = props.forceRender, children = props.children, motionName = props.motionName, leavedClassName = props.leavedClassName, eventProps = props.eventProps;
    var _React$useContext = React27.useContext(Context), contextMotion = _React$useContext.motion;
    ...
    var renderedRef = React27.useRef(mergedVisible);
    if (mergedVisible) {
      renderedRef.current = true;
    }
    var setNodeRef = React27.useCallback(function(node2) {
    ...
    if (React27.isValidElement(motionChildren) && supportRef(motionChildren)) {
      var _ref = motionChildren, originNodeRef = _ref.ref;
      if (!originNodeRef) {
        motionChildren = React27.cloneElement(motionChildren, {
          ref: setNodeRef
        });
      }
    }
    return React27.createElement(DomWrapper_default, {
      ref: wrapperNodeRef
    }, motionChildren);
  });
  ...
  var CSSMotionList = function(_React$Component) {
    ...
    _createClass(CSSMotionList2, [{
      ...
      value: function render() {
        ...
        var Component3 = component || React28.Fragment;
        var motionProps = {};
        ...
        return React28.createElement(Component3, restProps, keyEntities.map(function(_ref2, index) {
          var status = _ref2.status, eventProps = _objectWithoutProperties(_ref2, _excluded22);
          var visible = status === STATUS_ADD || status === STATUS_KEEP;
          return React28.createElement(CSSMotion, _extends({}, motionProps, {
            key: eventProps.key,
            visible,
            eventProps,
...
function MotionWrapper(props) {
  ...
  const needWrapMotionProviderRef = React29.useRef(false);
  needWrapMotionProviderRef.current = needWrapMotionProviderRef.current || motion === false;
  if (needWrapMotionProviderRef.current) {
    return React29.createElement(MotionProvider, {
      motion
    }, children);
  }
  return children;
...
var PropWarning = React30.memo((_ref) => {
  let {
...
var ProviderChildren = (props) => {
  ...
  const getPrefixCls = React31.useCallback((suffixCls, customizePrefixCls) => {
    const {
      prefixCls
    } = props;
    if (customizePrefixCls) {
  ...
  const memoIconContextValue = React31.useMemo(() => ({
    prefixCls: iconPrefixCls,
    csp
  }), [iconPrefixCls, csp]);
  let childNode = React31.createElement(React31.Fragment, null, React31.createElement(PropWarning_default, {
    dropdownMatchSelectWidth
  }), children);
  const validateMessages = React31.useMemo(() => {
    var _a, _b, _c, _d;
  ...
  if (Object.keys(validateMessages).length > 0) {
    childNode = React31.createElement(validateMessagesContext_default.Provider, {
      value: validateMessages
    }, childNode);
  }
  if (locale5) {
    childNode = React31.createElement(locale_default, {
      locale: locale5,
      _ANT_MARK__: ANT_MARK
    }, childNode);
  }
  if (iconPrefixCls || csp) {
    childNode = React31.createElement(Context_default.Provider, {
      value: memoIconContextValue
    }, childNode);
  }
  if (componentSize) {
    childNode = React31.createElement(SizeContextProvider, {
      size: componentSize
    }, childNode);
  }
  childNode = React31.createElement(MotionWrapper, null, childNode);
  const memoTheme = React31.useMemo(() => {
  ...
  if (theme) {
    childNode = React31.createElement(DesignTokenContext.Provider, {
      value: memoTheme
    }, childNode);
  }
  if (memoedConfig.warning) {
    childNode = React31.createElement(WarningContext.Provider, {
      value: memoedConfig.warning
    }, childNode);
  }
  if (componentDisabled !== void 0) {
    childNode = React31.createElement(DisabledContextProvider, {
      disabled: componentDisabled
    }, childNode);
  }
  return React31.createElement(ConfigContext.Provider, {
    value: memoedConfig
  }, childNode);
};
var ConfigProvider = (props) => {
  const context = React31.useContext(ConfigContext);
  const antLocale = React31.useContext(context_default);
  return React31.createElement(ProviderChildren, Object.assign({
...
var LayoutContext = React32.createContext({
  siderHook: {
    addSider: () => null,
    removeSider: () => null
  }
...
function generate2(node2, key, rootProps) {
  if (!rootProps) {
    return import_react17.default.createElement(node2.tag, _objectSpread2({
      key
  ...
  return import_react17.default.createElement(node2.tag, _objectSpread2(_objectSpread2({
    key
...
var RefIcon = React37.forwardRef(BarsOutlined2);
if (true) {
...
var RefIcon2 = React38.forwardRef(LeftOutlined2);
if (true) {
...
var RefIcon3 = React39.forwardRef(RightOutlined2);
if (true) {
...
var SiderContext = React40.createContext({});
...
var Sider = React40.forwardRef((props, ref) => {
  const {
  ...
  const renderSider = () => {
    ...
    const zeroWidthTrigger = parseFloat(String(collapsedWidth || 0)) === 0 ? React40.createElement("span", {
      onClick: toggle,
    ...
    }, trigger || React40.createElement(BarsOutlined_default2, null)) : null;
    const iconObj = {
      expanded: reverseArrow ? React40.createElement(RightOutlined_default2, null) : React40.createElement(LeftOutlined_default2, null),
      collapsed: reverseArrow ? React40.createElement(LeftOutlined_default2, null) : React40.createElement(RightOutlined_default2, null)
    };
    const status = collapsed ? "collapsed" : "expanded";
    const defaultTrigger = iconObj[status];
    const triggerDom = trigger !== null ? zeroWidthTrigger || React40.createElement("div", {
    ...
    return React40.createElement("aside", Object.assign({
      className: siderCls
    }, divProps, {
      style: divStyle,
      ref
  ...
  return React40.createElement(SiderContext.Provider, {
    value: contextValue
  }, renderSider());
});
if (true) {
...
function generator(_ref) {
  ...
  return (BasicComponent) => {
    const Adapter = React41.forwardRef((props, ref) => React41.createElement(BasicComponent, Object.assign({
      ref,
      suffixCls,
      tagName
    }, props)));
...
var Basic = React41.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    suffixCls,
    className,
  ...
  return wrapSSR(React41.createElement(TagName, Object.assign({
    className: (0, import_classnames4.default)(customizePrefixCls || prefixWithSuffixCls, className, hashId, cssVarCls),
    ref
  }, others)));
});
var BasicLayout = React41.forwardRef((props, ref) => {
  const {
    direction
  } = React41.useContext(ConfigContext);
  const [siders, setSiders] = React41.useState([]);
  const {
    prefixCls: customizePrefixCls,
    className,
    rootClassName,
  ...
  return wrapCSSVar(React41.createElement(LayoutContext.Provider, {
    value: contextValue
  }, React41.createElement(Tag, Object.assign({
    ref,
    className: classString,
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-K27Z7BXX.js.map
